                  ...
                  <dx:GridViewCommandColumn ShowDeleteButton="true" ShowEditButton="false" ShowNewButtonInHeader="false" VisibleIndex="0">
                     <HeaderStyle Wrap="True" />
                                       ...
                                       <HeaderStyle Wrap="True"></HeaderStyle>
                                                    ...
                                                    <dx:GridViewDataTextColumn FieldName="DEPARTAMENTO" Name="DEPARTAMENTO" Caption="DEPARTAMENTO"   VisibleIndex="2" Visible="false">
                                       <HeaderStyle Wrap="True"></HeaderStyle>
                 </dx:GridViewDataTextColumn>
                                                     <dx:GridViewDataTextColumn FieldName="MUNICIPIO" Name="MUNICIPIO" Caption="DEPARTAMENTO"   VisibleIndex="3" Visible="true">
                                       <HeaderStyle Wrap="True"></HeaderStyle>
                       <Settings AutoFilterCondition="Contains" />
                     <Settings />
                 </dx:GridViewDataTextColumn>
         ...
         <asp:View ID="frmSubProd" runat="server">
            ...
            <br />
                 ...
                 <div class="frame" id="territorio" runat="server">
                           <label for="txtsubCod" aria-required="true"><font color="red">*</font>Número de departamentos priorizados: <asp:Label ID="lblSubMunos" runat="server" CssClass="text-secondary"></asp:Label></label>

                     <div class="form-group">
                           <label for="txtsubCod" aria-required="true"><font color="red">*</font>¿Necesita vincular este subproducto a territorio? Al desplegar la tabla seleccione el(los) departamento(s) a vincular: </label>
             ...
             <asp:Panel ID="munoPriorizados" runat="server"  style="display:none">
                 <div class="form-group">
                                ...
                                <dx:ASPxGridView ID="gvTerritorio" runat="server" Theme="Office2010Blue" Width="100%"   KeyFieldName="COD_DEPTO"  SettingsPager-Mode="ShowAllRecords" OnSelectionChanged="gvTerritorio_SelectionChanged" EnableCallBacks="false">
                                    <Settings ShowFooter="True"/>                           
                            <SettingsLoadingPanel Text="Cargando&amp;hellip;" />
