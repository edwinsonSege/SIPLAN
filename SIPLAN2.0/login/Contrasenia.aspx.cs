...
namespace SIPLAN2._0.login
{
	public partial class Contrasenia : System.Web.UI.Page
	{
        ...
        protected void btnContrasena_Click(object sender, EventArgs e)
        {
            ...
            OracleParameter[] pUser = { new OracleParameter("usuario", OracleDbType.Varchar2) { Value = usuario } };
        ...
        protected int ActualizaPass(string user, string pass)
        {
            ...
            OracleParameter[] pParams = {
                new OracleParameter("pass", OracleDbType.Varchar2) { Value = pass },
                new OracleParameter("user", OracleDbType.Varchar2) { Value = user }
            };
            estados = dao.comando(sql, pParams);
            return estados;
        }
