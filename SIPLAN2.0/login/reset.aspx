<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="reset.aspx.cs" Inherits="SIPLAN2._0.login.reset" %>
...
<h4 class="text-danger">Debe tener al menos una letra mayuscula</h4>
    ...
    <div class="form-group">
               ...
               <ContentTemplate>
                    <asp:TextBox ID="txtContrasena" runat="server" CssClass="form-control"  PlaceHolder="Nueva contraseña" Width="400"  TextMode="Password" minlength="6" onkeypress="return validapass(event);"></asp:TextBox>
                   </ContentTemplate>
                         </asp:UpdatePanel>
    ...
    <div class="form-group">
               ...
               <ContentTemplate>  
         <asp:TextBox ID="txtConfirme" runat="server" CssClass="form-control"  PlaceHolder="Nueva contraseña"  Width="400" TextMode="Password" minlength="6" onkeypress="return validapass(event);"></asp:TextBox>
